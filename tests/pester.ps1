...
Remove-Module LeastPrivilegedEntra -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\LeastPrivilegedEntra\LeastPrivilegedEntra.psd1"
Import-Module "$PSScriptRoot\..\LeastPrivilegedEntra\LeastPrivilegedEntra.psm1" -Force
