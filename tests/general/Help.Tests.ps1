...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\LeastPrivilegedEntra\functions", "$global:testroot\..\LeastPrivilegedEntra\internal\functions"),
	
	[string]
	$ModuleName = "LeastPrivilegedEntra",
...
$CommandPath = @(
    "$global:testroot\..\LeastPrivilegedEntra\functions"
    "$global:testroot\..\LeastPrivilegedEntra\internal\functions"
)
